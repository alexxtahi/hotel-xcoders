            ...
            <div class="row">
                <div class="col-lg-6 p-0 order-lg-2 order-md-2 col-md-6">
                    <div class="room__pic__slider owl-carousel">
                        <div class="room__pic__item set-bg" data-setbg="{{ asset('template/img/rooms/room-1.jpg') }}"></div>
                        <div class="room__pic__item set-bg" data-setbg="{{ asset('template/img/rooms/room-2.jpg') }}"></div>
                        <div class="room__pic__item set-bg" data-setbg="{{ asset('template/img/rooms/room-3.jpg') }}"></div>
                        <div class="room__pic__item set-bg" data-setbg="{{ asset('template/img/rooms/room-4.jpg') }}"></div>
                    </div>
                </div>
